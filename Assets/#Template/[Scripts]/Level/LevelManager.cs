    ...
    public static class LevelManager
    {
        ...
        public static GameStatus GameState
        {
            ...
            set  {
                ...
                gameState = value;
                OnGameStateChanged?.Invoke(gameState); // ´¥·¢ÊÂ¼þ
            }
        }
        ...
        public static event Action<GameStatus> OnGameStateChanged;
        ...
        public static void PlayerDeath(Player player, DieReason reason, GameObject cubes = null, Collision collision = null, bool revive = false)
        {
            ...
            foreach (PlayAnimator p in UnityEngine.Object.FindObjectsOfType<PlayAnimator>(true)) foreach (SingleAnimator s in p.animators) if (!s.dontRevive) s.StopAnimator();
        ...
        {
            float percentage = complete ? 1f : Player.Instance.SoundTrackProgress / 100f;
        ...
        public static void GameOverRevive()
        {
            ...
            {
                LevelUI.Instance.RevivePage(Player.Instance.SoundTrackProgress / 100f);
            }
        }
        ...
        public static void DestroyRemain()
        {
            ...
            trackFadeOut?.Kill();
            if (dieCubes) UnityEngine.Object.Destroy(dieCubes);
        }
